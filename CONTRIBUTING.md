...
Adding or changing an MCP tool? Read [docs/adding-a-tool.md](docs/adding-a-tool.md) first — it walks through the layering contracts, the registration ritual, and the test conventions. Looking for a starter task? See the good first issue label.
